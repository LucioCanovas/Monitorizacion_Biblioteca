...
def descargar():
    if request.method == 'POST':
        ...
        return redirect(url_for('mostrar_archivos', codigo_bib=codigo_bib, intervalo=intervalo, rol=rol_usuario))

    return render_template('archivos.html')


@app.route('/descargar/<codigo_bib>/<intervalo>/<rol>')
@login_required
def mostrar_archivos(codigo_bib, intervalo, rol):
    ...
    # Obtener solo los nombres de los archivos ordenados
    ...
    return render_template('archivos.html', archivos=archivos_pagina, codigo_bib=codigo_bib, intervalo=intervalo, num_paginas=num_paginas, pagina_actual=pagina, rol=rol)
...
def eliminar_archivo(codigo_bib, intervalo, nombre):
    ...
    if rol != 'admin':
        ...
        return redirect(url_for('mostrar_archivos', codigo_bib=codigo_bib, intervalo=intervalo, rol=rol))
...
if __name__ == '__main__':
    ...
    cert_file = r'/app/Openssl/certificado_firmado.pem'
    key_file = r'/app/Openssl/clave_privada.pem'
